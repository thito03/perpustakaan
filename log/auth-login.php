    ...
    <main class="auth-cover-wrapper">
        <div class="auth-cover-content-inner">
            <div class="auth-cover-content-wrapper">
                <div class="auth-img">
                    <img src="https://images.pexels.com/photos/757855/pexels-photo-757855.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" class="img-fluid">
                </div>
            </div>
        </div>
            ...
            <div class="auth-cover-card-wrapper">
                <div class="auth-cover-card p-sm-5">
                    ...
                    <form action="../assets/config/try_in.php" method="post" class="w-100 mt-4 pt-2">
                        ...
                        <div class="mb-3">
                            <input type="password" name="password" class="form-control" value="thito" placeholder="Password" required>
                        </div>
